...
import com.example.demo.securityLogin.LoginFailHandler;
import com.example.demo.securityLogin.LoginSuccessHandler;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		return http.httpBasic().disable() // token을 사용하므로 basic 인증 disable (사용안함)
				...
				.authorizeRequests()
					...
					.antMatchers("/api/member/**", "/auth/logout").hasRole("USER")
					...
					//.antMatchers("/", "/home", "/user/**", "/member/**", "/board/**", "/resources/**", "/uploadImage/**").permitAll() 
