...
//2) @Query : JPQL(JPA 가 지원하는 sql 구문 형식), Native_SQL(sql 구문 그대로 집어 넣는 방식)
//3) JPA Criteria
//4) QueryDSL
...
//( https://blog.naver.com/mion0602/223183393956 : 메서드 규약 )
...
public interface MemberRepository extends JpaRepository<Member, String> {
	...
	// 2.1) JPQL
	// => table 명 대신에 Entity 명을 사용해야 함 (Entity 클래스 명과 완전 일치)
	@Modifying
	@Transactional
