...
public class Ex06_mkDir {
	...
	public static void main(String[] args) {
		...
		// File f2 = new File("C:\\MTest1\\MyWork1\\ppp") ;
		...
		listDirectory(new File("C:\\MTest\\MyWork"));    // d:\\MTest\\MyWork 의 목록 출력
		f2.renameTo(new File("C:\\MTest\\MyWork\\aaa")); // aaa -> bbb 로 이름 변경
		listDirectory(new File("C:\\MTest\\MyWork"));    // bbb 로 변경한 후 리스트 출력
