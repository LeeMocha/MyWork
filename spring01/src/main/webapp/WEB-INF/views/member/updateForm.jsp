...
<table>
		<tr height="40">
			<td bgcolor="LightPueple"><label for="id">I D </label></td>
			<td><input type="text" id="id" name="id" size ="30" value="${ m.id }" readonly ></td>
		</tr>
		<tr height="40">
			<td bgcolor="LightPueple"><label for="password">Password </label></td>
			<td><input type="password" id="password" name="password" value="${ m.password }" size ="30"></td>
		</tr>
		<tr height="40">
			<td bgcolor="LightPueple"><label for="name">Name </label></td>
			<td><input type="text" id="name" name="name" value="${ m.name }" size ="30"></td>
		</tr>
		<tr height="40">
			<td bgcolor="LightPueple"><label for="age">Age </label></td>
			<td><input type="text" id="age" name="age" value="${ m.age }" size ="30"></td>
		</tr>
		<tr height="40">
			<td bgcolor="LightPueple"><label for="jno">Jno </label></td>
			<td>
		...
		<tr height="40">
			<td bgcolor="LightPueple"><label for="info">Info </label></td>
			<td><input type="text" id="info" name="info" value="${ m.info }" size ="30"></td>
		</tr>
		<tr height="40">
			<td bgcolor="LightPueple"><label for="point">Point</label></td>
			<td><input type="text" id="point" name="point" value="${ m.point }" size ="30"></td>
		</tr>
		<tr height="40">
			<td bgcolor="LightPueple"><label for="birthday">Birthday </label></td>
			<td><input type="date" id="birthday" name="birthday" value="${ m.birthday }"></td>
		</tr>
		<tr height="40">
			<td bgcolor="LightPueple"><label for="rid">추천인 </label></td>
