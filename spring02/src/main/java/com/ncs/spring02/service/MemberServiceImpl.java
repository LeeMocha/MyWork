...
//=> xml의 경우엔 resources 패키지에서 찾게되니 거기다 패키지명도 똑같이 해서 만들어주어야 함.
...
// -> 즉, Java interface, Mapper, Mapper 의 namespace 에 들어가는 이름에 package 및 파일명이 다 동일해야함.
// -> 그리고 구현할 method는 Mapper.xml 구문의 id 속성 값으로 찾음.
...
//	MemberDAO dao;
	...
	// ** Mybatis 적용
	// => mapper 의 구현체는 스프링이 실행시에 자동으로 만들어 주입해줌.
