...
// => Factory 패턴 적용
// - ServiceFactory
// - 개별컨트롤러(일반클래스) : 연관성을 위해 강제성 부여 ( interface 사용 )
...
public class Ex02_FrontController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// ~URI => /web02/test.fo
		// ~URL => http://localhost:8080/web02/test.fo
		...
		// => ServiceFactory 생성 : 허용하지 않음 (싱글톤 패턴 적용으로)
...
//		System.out.printf("** 싱글톤 패턴 Test : sf = %s, sf1 = %s, sf2 = %s \n",sf, sf1, sf2);
